...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\textbf{Counting Assessment}}
\fancyfoot[C]{\thepage}
...
\begin{document}
\small
Problems in Sections A and B come from the easier Counting practice set. Problems in Sections C and D come from the harder Counting practice set. \newline
You do not need to simplify your answers. 

\begin{multicols}{2}
% Document body goes here
\input{../counting_problem_sections/counting_section_a_intro.tex}
\input{../counting_problem_sections/counting_section_b_principles_and_formulas.tex}
\input{../counting_problem_sections/counting_section_c_applied_mcq.tex}
\input{../counting_problem_sections/counting_section_d_advanced_free_response.tex}
\end{multicols}
\end{document}
