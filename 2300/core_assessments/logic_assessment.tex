...
% Canonical compact three-column source for the Logic Core.
...
\begin{tcolorbox}
\textbf{Time limit: 20 minutes.} Course staff will designate one problem in
each section A--E. Complete all five designated problems. Show enough work to
make your reasoning clear, define requested predicates and domains, and follow
the directions for every lettered part. Approved testing accommodations apply.
\end{tcolorbox}
