...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\textbf{Core Assessment 3 2026-01-27}}
\fancyfoot[C]{\thepage}
...
% --- Content ---
The following problems are a pool of items for your \textbf{C3 Assessment — Sets}. \textbf{Please practice these problems!}
\begin{multicols}{3}
