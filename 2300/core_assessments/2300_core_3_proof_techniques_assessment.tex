...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\textbf{Core Assessment 3 2026-02-27}}
\fancyfoot[C]{\thepage}
...
The following problems are a pool of items for your \textbf{C3 Assessment — Proof Techniques}. \textbf{Please practice these problems!}

\begin{multicols}{2}

\section*{C3. Proof Techniques}
